<?php
/**
 * Knut Svenssons Rör AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Knut Svenssons Rör AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through kn_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'knutsvenssonsror', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'knutsvenssonsror' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'knutsvenssonsror' ) ) );

		register_block_pattern_category( 'knutsvenssonsror-sections', array( 'label' => __( 'Knut Svenssons Rör AB sections', 'knutsvenssonsror' ) ) );
		register_block_pattern_category( 'knutsvenssonsror-pages', array( 'label' => __( 'Knut Svenssons Rör AB page layouts', 'knutsvenssonsror' ) ) );
	}
);
