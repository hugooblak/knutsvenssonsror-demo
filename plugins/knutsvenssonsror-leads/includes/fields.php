...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'knutsvenssonsror-leads' ),
				'storm'       => __( 'Storm or hail damage', 'knutsvenssonsror-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'knutsvenssonsror-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'knutsvenssonsror-leads' ),
				'not-sure'    => __( 'Vet inte än', 'knutsvenssonsror-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'knutsvenssonsror-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'knutsvenssonsror-leads' ),
				'research' => __( 'Jag kollar bara priser', 'knutsvenssonsror-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'knutsvenssonsror-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'knutsvenssonsror-leads' ),
		'contacted' => __( 'Kontaktad', 'knutsvenssonsror-leads' ),
		'quoted'    => __( 'Quote sent', 'knutsvenssonsror-leads' ),
		'won'       => __( 'Won', 'knutsvenssonsror-leads' ),
		'lost'      => __( 'Lost', 'knutsvenssonsror-leads' ),
		'spam'      => __( 'Misstänkt spam', 'knutsvenssonsror-leads' ),
	);
}
